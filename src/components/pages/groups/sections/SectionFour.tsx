...
const features = [
  ...
  },
  {
    ...
    title: "Финансовая расстановка",
    description: "Оптимизация финансовой стратегии и улучшение показателей.",
  },
  {
    icon: <Gamepad size={28} />,
    title: "Трансформационная игра",
    description: "Интерактивный подход к развитию лидерских качеств.",
  },
  {
