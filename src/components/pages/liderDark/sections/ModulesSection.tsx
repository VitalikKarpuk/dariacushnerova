          ...
          return (
            <StaggerItem key={module.title} as="li" className={isBonus ? "lg:col-span-2" : ""}>
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden rounded-xl border border-white/[0.08] md:row-span-2">
                  {module.image ? (
                    <img
                      src={module.image}
                      ...
                      loading="lazy"
                      decoding="async"
                      className="h-full w-full object-cover transition-transform duration-500 ease-expo group-hover:scale-[1.05]"
                    />
                  ) : (
                    <div
                      className="h-full bg-gradient-to-br from-white/[0.06] via-transparent to-[#5E6AD2]/[0.08]"
                      aria-hidden
                    />
                  )}
                </div>
                ...
                <div className="min-w-0">
                  {isBonus && (
                    <span className="mb-2.5 inline-block rounded-full border border-[#5E6AD2]/40 bg-[#5E6AD2]/15 px-3 py-1 font-mono text-[11px] uppercase tracking-widest text-white">
                      Бонус
                    </span>
                  )}
                ...
                <p className="col-span-2 mt-1.5 border-t border-white/[0.06] pt-4 text-sm leading-relaxed text-linear-fg">
                  <Target
                    className="mr-2 inline-block h-3.5 w-3.5 align-[-2px] text-linear-accent-bright"
                    aria-hidden
                  />
                  <span className="font-mono text-[11px] uppercase tracking-widest text-linear-accent-bright">
                    Результат
                  </span>
                  {" — "}
                  {module.result}
