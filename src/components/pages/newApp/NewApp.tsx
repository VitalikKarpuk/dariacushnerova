...
function NewApp() {
  return (
    <>
      ...
      <TestComponent />
      <div className="my-6 text-center container">
        <p className="text-xl md:text-2xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-[#0B243D] to-[#2A6F97]">
          На конференции{" "}
      ...
      <div className="bg-gradient-to-r from-[#0b243d] to-[#081a2b] p-10 text-white text-center rounded-lg shadow-lg mt-10">
        ...
        <p className="text-xl md:text-2xl font-semibold leading-relaxed opacity-90">
